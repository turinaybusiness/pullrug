 ...
 * Club GSAP members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var Yd,Bi,ur,Bh,_s,jd,zh,Lb=function(){return typeof window<"u"},Mi={},us=180/Math.PI,dr=Math.PI/180,er=Math.atan2,Kd=1e8,kh=/([A-Z])/g,Nb=/(left|right|width|margin|padding|x)/i,Db=/[\s,\(]\S/,Xn={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},Yl=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},Ub=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},Fb=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},Ob=function(e,t){var n=t.s+t.c*e;t.set(t.t,t.p,~~(n+(n<0?-.5:.5))+t.u,t)},Yp=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},jp=function(e,t){return t.set(t.t,t.p,e!==1?t.b:t.e,t)},Bb=function(e,t,n){return e.style[t]=n},zb=function(e,t,n){return e.style.setProperty(t,n)},kb=function(e,t,n){return e._gsap[t]=n},Vb=function(e,t,n){return e._gsap.scaleX=e._gsap.scaleY=n},Hb=function(e,t,n,i,s){var r=e._gsap;r.scaleX=r.scaleY=n,r.renderTransform(s,r)},Gb=function(e,t,n,i,s){var r=e._gsap;r[t]=n,r.renderTransform(s,r)},ut="transform",sn=ut+"Origin",Wb=function o(e,t){var n=this,i=this.target,s=i.style,r=i._gsap;if(e in Mi&&s){if(this.tfm=this.tfm||{},e!=="transform")e=Xn[e]||e,~e.indexOf(",")?e.split(",").forEach(function(a){return n.tfm[a]=pi(i,a)}):this.tfm[e]=r.x?r[e]:pi(i,e),e===sn&&(this.tfm.zOrigin=r.zOrigin);else return Xn.transform.split(",").forEach(function(a){return o.call(n,a,t)});if(this.props.indexOf(ut)>=0)return;r.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(sn,t,"")),e=ut}(s||t)&&this.props.push(e,t,s[e])},Kp=function(e){e.translate&&(e.removeProperty("translate"),e.removeProperty("scale"),e.removeProperty("rotate"))},Xb=function(){var e=this.props,t=this.target,n=t.style,i=t._gsap,s,r;for(s=0;s<e.length;s+=3)e[s+1]?t[e[s]]=e[s+2]:e[s+2]?n[e[s]]=e[s+2]:n.removeProperty(e[s].substr(0,2)==="--"?e[s]:e[s].replace(kh,"-$1").toLowerCase());if(this.tfm){for(r in this.tfm)i[r]=this.tfm[r];i.svg&&(i.renderTransform(),t.setAttribute("data-svg-origin",this.svgo||"")),s=zh(),(!s||!s.isStart)&&!n[ut]&&(Kp(n),i.zOrigin&&n[sn]&&(n[sn]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},$p=function(e,t){var n={target:e,props:[],revert:Xb,save:Wb};return e._gsap||rn.core.getCache(e),t&&t.split(",").forEach(function(i){return n.save(i)}),n},Zp,jl=function(e,t){var n=Bi.createElementNS?Bi.createElementNS((t||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),e):Bi.createElement(e);return n&&n.style?n:Bi.createElement(e)},Yn=function o(e,t,n){var i=getComputedStyle(e);return i[t]||i.getPropertyValue(t.replace(kh,"-$1").toLowerCase())||i.getPropertyValue(t)||!n&&o(e,Rr(t)||t,1)||""},$d="O,Moz,ms,Ms,Webkit".split(","),Rr=function(e,t,n){var i=t||_s,s=i.style,r=5;if(e in s&&!n)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);r--&&!($d[r]+e in s););return r<0?null:(r===3?"ms":r>=0?$d[r]:"")+e},Kl=function(){Lb()&&window.document&&(Yd=window,Bi=Yd.document,ur=Bi.documentElement,_s=jl("div")||{style:{}},jl("div"),ut=Rr(ut),sn=ut+"Origin",_s.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",Zp=!!Rr("perspective"),zh=rn.core.reverting,Bh=1)},Kc=function o(e){var t=jl("svg",this.ownerSVGElement&&this.ownerSVGElement.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),n=this.parentNode,i=this.nextSibling,s=this.style.cssText,r;if(ur.appendChild(t),t.appendChild(this),this.style.display="block",e)try{r=this.getBBox(),this._gsapBBox=this.getBBox,this.getBBox=o}catch{}else this._gsapBBox&&(r=this._gsapBBox());return n&&(i?n.insertBefore(this,i):n.appendChild(this)),ur.removeChild(t),this.style.cssText=s,r},Zd=function(e,t){for(var n=t.length;n--;)if(e.hasAttribute(t[n]))return e.getAttribute(t[n])},Jp=function(e){var t;try{t=e.getBBox()}catch{t=Kc.call(e,!0)}return t&&(t.width||t.height)||e.getBBox===Kc||(t=Kc.call(e,!0)),t&&!t.width&&!t.x&&!t.y?{x:+Zd(e,["x","cx","x1"])||0,y:+Zd(e,["y","cy","y1"])||0,width:0,height:0}:t},Qp=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&Jp(e))},As=function(e,t){if(t){var n=e.style,i;t in Mi&&t!==sn&&(t=ut),n.removeProperty?(i=t.substr(0,2),(i==="ms"||t.substr(0,6)==="webkit")&&(t="-"+t),n.removeProperty(i==="--"?t:t.replace(kh,"-$1").toLowerCase())):n.removeAttribute(t)}},zi=function(e,t,n,i,s,r){var a=new nn(e._pt,t,n,0,1,r?jp:Yp);return e._pt=a,a.b=i,a.e=s,e._props.push(n),a},Jd={deg:1,rad:1,turn:1},qb={grid:1,flex:1},ji=function o(e,t,n,i){var s=parseFloat(n)||0,r=(n+"").trim().substr((s+"").length)||"px",a=_s.style,c=Nb.test(t),l=e.tagName.toLowerCase()==="svg",h=(l?"client":"offset")+(c?"Width":"Height"),u=100,d=i==="px",f=i==="%",_,g,p,m;if(i===r||!s||Jd[i]||Jd[r])return s;if(r!=="px"&&!d&&(s=o(e,t,n,"px")),m=e.getCTM&&Qp(e),(f||r==="%")&&(Mi[t]||~t.indexOf("adius")))return _=m?e.getBBox()[c?"width":"height"]:e[h],vt(f?s/_*u:s/100*_);if(a[c?"width":"height"]=u+(d?r:i),g=~t.indexOf("adius")||i==="em"&&e.appendChild&&!l?e:e.parentNode,m&&(g=(e.ownerSVGElement||{}).parentNode),(!g||g===Bi||!g.appendChild)&&(g=Bi.body),p=g._gsap,p&&f&&p.width&&c&&p.time===dn.time&&!p.uncache)return vt(s/p.width*u);if(f&&(t==="height"||t==="width")){var v=e.style[t];e.style[t]=u+i,_=e[h],v?e.style[t]=v:As(e,t)}else(f||r==="%")&&!qb[Yn(g,"display")]&&(a.position=Yn(e,"position")),g===e&&(a.position="static"),g.appendChild(_s),_=_s[h],g.removeChild(_s),a.position="absolute";return c&&f&&(p=vs(g),p.time=dn.time,p.width=g[h]),vt(d?_*s/u:_&&s?u/_*s:0)},pi=function(e,t,n,i){var s;return Bh||Kl(),t in Xn&&t!=="transform"&&(t=Xn[t],~t.indexOf(",")&&(t=t.split(",")[0])),Mi[t]&&t!=="transform"?(s=vo(e,i),s=t!=="transformOrigin"?s[t]:s.svg?s.origin:za(Yn(e,sn))+" "+s.zOrigin+"px"):(s=e.style[t],(!s||s==="auto"||i||~(s+"").indexOf("calc("))&&(s=Ba[t]&&Ba[t](e,t,n)||Yn(e,t)||mp(e,t)||(t==="opacity"?1:0))),n&&!~(s+"").trim().indexOf(" ")?ji(e,t,s,n)+n:s},Yb=function(e,t,n,i){if(!n||n==="none"){var s=Rr(t,e,1),r=s&&Yn(e,s,1);r&&r!==n?(t=s,n=r):t==="borderColor"&&(n=Yn(e,"borderTopColor"))}var a=new nn(this._pt,e.style,t,0,1,Wp),c=0,l=0,h,u,d,f,_,g,p,m,v,x,M,w;if(a.b=n,a.e=i,n+="",i+="",i==="auto"&&(g=e.style[t],e.style[t]=i,i=Yn(e,t)||i,g?e.style[t]=g:As(e,t)),h=[n,i],Dp(h),n=h[0],i=h[1],d=n.match(sr)||[],w=i.match(sr)||[],w.length){for(;u=sr.exec(i);)p=u[0],v=i.substring(c,u.index),_?_=(_+1)%5:(v.substr(-5)==="rgba("||v.substr(-5)==="hsla(")&&(_=1),p!==(g=d[l++]||"")&&(f=parseFloat(g)||0,M=g.substr((f+"").length),p.charAt(1)==="="&&(p=hr(f,p)+M),m=parseFloat(p),x=p.substr((m+"").length),c=sr.lastIndex-x.length,x||(x=x||pn.units[t]||M,c===i.length&&(i+=x,a.e+=x)),M!==x&&(f=ji(e,t,g,x)||0),a._pt={_next:a._pt,p:v||l===1?v:",",s:f,c:m-f,m:_&&_<4||t==="zIndex"?Math.round:0});a.c=c<i.length?i.substring(c,i.length):""}else a.r=t==="display"&&i==="none"?jp:Yp;return lp.test(i)&&(a.e=0),this._pt=a,a},Qd={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},jb=function(e){var t=e.split(" "),n=t[0],i=t[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(e=n,n=i,i=e),t[0]=Qd[n]||n,t[1]=Qd[i]||i,t.join(" ")},Kb=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var n=t.t,i=n.style,s=t.u,r=n._gsap,a,c,l;if(s==="all"||s===!0)i.cssText="",c=1;else for(s=s.split(","),l=s.length;--l>-1;)a=s[l],Mi[a]&&(c=1,a=a==="transformOrigin"?sn:ut),As(n,a);c&&(As(n,ut),r&&(r.svg&&n.removeAttribute("transform"),vo(n,1),r.uncache=1,Kp(i)))}},Ba={clearProps:function(e,t,n,i,s){if(s.data!=="isFromStart"){var r=e._pt=new nn(e._pt,t,n,0,0,Kb);return r.u=i,r.pr=-10,r.tween=s,e._props.push(n),1}}},go=[1,0,0,1,0,0],em={},tm=function(e){return e==="matrix(1, 0, 0, 1, 0, 0)"||e==="none"||!e},ef=function(e){var t=Yn(e,ut);return tm(t)?go:t.substr(7).match(cp).map(vt)},Vh=function(e,t){var n=e._gsap||vs(e),i=e.style,s=ef(e),r,a,c,l;return n.svg&&e.getAttribute("transform")?(c=e.transform.baseVal.consolidate().matrix,s=[c.a,c.b,c.c,c.d,c.e,c.f],s.join(",")==="1,0,0,1,0,0"?go:s):(s===go&&!e.offsetParent&&e!==ur&&!n.svg&&(c=i.display,i.display="block",r=e.parentNode,(!r||!e.offsetParent)&&(l=1,a=e.nextElementSibling,ur.appendChild(e)),s=ef(e),c?i.display=c:As(e,"display"),l&&(a?r.insertBefore(e,a):r?r.appendChild(e):ur.removeChild(e))),t&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},$l=function(e,t,n,i,s,r){var a=e._gsap,c=s||Vh(e,!0),l=a.xOrigin||0,h=a.yOrigin||0,u=a.xOffset||0,d=a.yOffset||0,f=c[0],_=c[1],g=c[2],p=c[3],m=c[4],v=c[5],x=t.split(" "),M=parseFloat(x[0])||0,w=parseFloat(x[1])||0,T,b,R,y;n?c!==go&&(b=f*p-_*g)&&(R=M*(p/b)+w*(-g/b)+(g*v-p*m)/b,y=M*(-_/b)+w*(f/b)-(f*v-_*m)/b,M=R,w=y):(T=Jp(e),M=T.x+(~x[0].indexOf("%")?M/100*T.width:M),w=T.y+(~(x[1]||x[0]).indexOf("%")?w/100*T.height:w)),i||i!==!1&&a.smooth?(m=M-l,v=w-h,a.xOffset=u+(m*f+v*g)-m,a.yOffset=d+(m*_+v*p)-v):a.xOffset=a.yOffset=0,a.xOrigin=M,a.yOrigin=w,a.smooth=!!i,a.origin=t,a.originIsAbsolute=!!n,e.style[sn]="0px 0px",r&&(zi(r,a,"xOrigin",l,M),zi(r,a,"yOrigin",h,w),zi(r,a,"xOffset",u,a.xOffset),zi(r,a,"yOffset",d,a.yOffset)),e.setAttribute("data-svg-origin",M+" "+w)},vo=function(e,t){var n=e._gsap||new Bp(e);if("x"in n&&!t&&!n.uncache)return n;var i=e.style,s=n.scaleX<0,r="px",a="deg",c=getComputedStyle(e),l=Yn(e,sn)||"0",h,u,d,f,_,g,p,m,v,x,M,w,T,b,R,y,S,I,D,P,U,F,L,G,V,$,re,oe,te,Oe,Y,J;return h=u=d=g=p=m=v=x=M=0,f=_=1,n.svg=!!(e.getCTM&&Qp(e)),c.translate&&((c.translate!=="none"||c.scale!=="none"||c.rotate!=="none")&&(i[ut]=(c.translate!=="none"?"translate3d("+(c.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(c.rotate!=="none"?"rotate("+c.rotate+") ":"")+(c.scale!=="none"?"scale("+c.scale.split(" ").join(",")+") ":"")+(c[ut]!=="none"?c[ut]:"")),i.scale=i.rotate=i.translate="none"),b=Vh(e,n.svg),n.svg&&(n.uncache?(V=e.getBBox(),l=n.xOrigin-V.x+"px "+(n.yOrigin-V.y)+"px",G=""):G=!t&&e.getAttribute("data-svg-origin"),$l(e,G||l,!!G||n.originIsAbsolute,n.smooth!==!1,b)),w=n.xOrigin||0,T=n.yOrigin||0,b!==go&&(I=b[0],D=b[1],P=b[2],U=b[3],h=F=b[4],u=L=b[5],b.length===6?(f=Math.sqrt(I*I+D*D),_=Math.sqrt(U*U+P*P),g=I||D?er(D,I)*us:0,v=P||U?er(P,U)*us+g:0,v&&(_*=Math.abs(Math.cos(v*dr))),n.svg&&(h-=w-(w*I+T*P),u-=T-(w*D+T*U))):(J=b[6],Oe=b[7],re=b[8],oe=b[9],te=b[10],Y=b[11],h=b[12],u=b[13],d=b[14],R=er(J,te),p=R*us,R&&(y=Math.cos(-R),S=Math.sin(-R),G=F*y+re*S,V=L*y+oe*S,$=J*y+te*S,re=F*-S+re*y,oe=L*-S+oe*y,te=J*-S+te*y,Y=Oe*-S+Y*y,F=G,L=V,J=$),R=er(-P,te),m=R*us,R&&(y=Math.cos(-R),S=Math.sin(-R),G=I*y-re*S,V=D*y-oe*S,$=P*y-te*S,Y=U*S+Y*y,I=G,D=V,P=$),R=er(D,I),g=R*us,R&&(y=Math.cos(R),S=Math.sin(R),G=I*y+D*S,V=F*y+L*S,D=D*y-I*S,L=L*y-F*S,I=G,F=V),p&&Math.abs(p)+Math.abs(g)>359.9&&(p=g=0,m=180-m),f=vt(Math.sqrt(I*I+D*D+P*P)),_=vt(Math.sqrt(L*L+J*J)),R=er(F,L),v=Math.abs(R)>2e-4?R*us:0,M=Y?1/(Y<0?-Y:Y):0),n.svg&&(G=e.getAttribute("transform"),n.forceCSS=e.setAttribute("transform","")||!tm(Yn(e,ut)),G&&e.setAttribute("transform",G))),Math.abs(v)>90&&Math.abs(v)<270&&(s?(f*=-1,v+=g<=0?180:-180,g+=g<=0?180:-180):(_*=-1,v+=v<=0?180:-180)),t=t||n.uncache,n.x=h-((n.xPercent=h&&(!t&&n.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-h)?-50:0)))?e.offsetWidth*n.xPercent/100:0)+r,n.y=u-((n.yPercent=u&&(!t&&n.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-u)?-50:0)))?e.offsetHeight*n.yPercent/100:0)+r,n.z=d+r,n.scaleX=vt(f),n.scaleY=vt(_),n.rotation=vt(g)+a,n.rotationX=vt(p)+a,n.rotationY=vt(m)+a,n.skewX=v+a,n.skewY=x+a,n.transformPerspective=M+r,(n.zOrigin=parseFloat(l.split(" ")[2])||!t&&n.zOrigin||0)&&(i[sn]=za(l)),n.xOffset=n.yOffset=0,n.force3D=pn.force3D,n.renderTransform=n.svg?Zb:Zp?nm:$b,n.uncache=0,n},za=function(e){return(e=e.split(" "))[0]+" "+e[1]},$c=function(e,t,n){var i=Vt(t);return vt(parseFloat(t)+parseFloat(ji(e,"x",n+"px",i)))+i},$b=function(e,t){t.z="0px",t.rotationY=t.rotationX="0deg",t.force3D=0,nm(e,t)},as="0deg",jr="0px",cs=") ",nm=function(e,t){var n=t||this,i=n.xPercent,s=n.yPercent,r=n.x,a=n.y,c=n.z,l=n.rotation,h=n.rotationY,u=n.rotationX,d=n.skewX,f=n.skewY,_=n.scaleX,g=n.scaleY,p=n.transformPerspective,m=n.force3D,v=n.target,x=n.zOrigin,M="",w=m==="auto"&&e&&e!==1||m===!0;if(x&&(u!==as||h!==as)){var T=parseFloat(h)*dr,b=Math.sin(T),R=Math.cos(T),y;T=parseFloat(u)*dr,y=Math.cos(T),r=$c(v,r,b*y*-x),a=$c(v,a,-Math.sin(T)*-x),c=$c(v,c,R*y*-x+x)}p!==jr&&(M+="perspective("+p+cs),(i||s)&&(M+="translate("+i+"%, "+s+"%) "),(w||r!==jr||a!==jr||c!==jr)&&(M+=c!==jr||w?"translate3d("+r+", "+a+", "+c+") ":"translate("+r+", "+a+cs),l!==as&&(M+="rotate("+l+cs),h!==as&&(M+="rotateY("+h+cs),u!==as&&(M+="rotateX("+u+cs),(d!==as||f!==as)&&(M+="skew("+d+", "+f+cs),(_!==1||g!==1)&&(M+="scale("+_+", "+g+cs),v.style[ut]=M||"translate(0, 0)"},Zb=function(e,t){var n=t||this,i=n.xPercent,s=n.yPercent,r=n.x,a=n.y,c=n.rotation,l=n.skewX,h=n.skewY,u=n.scaleX,d=n.scaleY,f=n.target,_=n.xOrigin,g=n.yOrigin,p=n.xOffset,m=n.yOffset,v=n.forceCSS,x=parseFloat(r),M=parseFloat(a),w,T,b,R,y;c=parseFloat(c),l=parseFloat(l),h=parseFloat(h),h&&(h=parseFloat(h),l+=h,c+=h),c||l?(c*=dr,l*=dr,w=Math.cos(c)*u,T=Math.sin(c)*u,b=Math.sin(c-l)*-d,R=Math.cos(c-l)*d,l&&(h*=dr,y=Math.tan(l-h),y=Math.sqrt(1+y*y),b*=y,R*=y,h&&(y=Math.tan(h),y=Math.sqrt(1+y*y),w*=y,T*=y)),w=vt(w),T=vt(T),b=vt(b),R=vt(R)):(w=u,R=d,T=b=0),(x&&!~(r+"").indexOf("px")||M&&!~(a+"").indexOf("px"))&&(x=ji(f,"x",r,"px"),M=ji(f,"y",a,"px")),(_||g||p||m)&&(x=vt(x+_-(_*w+g*b)+p),M=vt(M+g-(_*T+g*R)+m)),(i||s)&&(y=f.getBBox(),x=vt(x+i/100*y.width),M=vt(M+s/100*y.height)),y="matrix("+w+","+T+","+b+","+R+","+x+","+M+")",f.setAttribute("transform",y),v&&(f.style[ut]=y)},Jb=function(e,t,n,i,s){var r=360,a=Dt(s),c=parseFloat(s)*(a&&~s.indexOf("rad")?us:1),l=c-i,h=i+l+"deg",u,d;return a&&(u=s.split("_")[1],u==="short"&&(l%=r,l!==l%(r/2)&&(l+=l<0?r:-r)),u==="cw"&&l<0?l=(l+r*Kd)%r-~~(l/r)*r:u==="ccw"&&l>0&&(l=(l-r*Kd)%r-~~(l/r)*r)),e._pt=d=new nn(e._pt,t,n,i,l,Ub),d.e=h,d.u="deg",e._props.push(n),d},tf=function(e,t){for(var n in t)e[n]=t[n];return e},Qb=function(e,t,n){var i=tf({},n._gsap),s="perspective,force3D,transformOrigin,svgOrigin",r=n.style,a,c,l,h,u,d,f,_;i.svg?(l=n.getAttribute("transform"),n.setAttribute("transform",""),r[ut]=t,a=vo(n,1),As(n,ut),n.setAttribute("transform",l)):(l=getComputedStyle(n)[ut],r[ut]=t,a=vo(n,1),r[ut]=l);for(c in Mi)l=i[c],h=a[c],l!==h&&s.indexOf(c)<0&&(f=Vt(l),_=Vt(h),u=f!==_?ji(n,c,l,_):parseFloat(l),d=parseFloat(h),e._pt=new nn(e._pt,a,c,u,d-u,Yl),e._pt.u=_||0,e._props.push(c));tf(a,i)};tn("padding,margin,Width,Radius",function(o,e){var t="Top",n="Right",i="Bottom",s="Left",r=(e<3?[t,n,i,s]:[t+s,t+n,i+n,i+s]).map(function(a){return e<2?o+a:"border"+a+o});Ba[e>1?"border"+o:o]=function(a,c,l,h,u){var d,f;if(arguments.length<4)return d=r.map(function(_){return pi(a,_,l)}),f=d.join(" "),f.split(d[0]).length===5?d[0]:f;d=(h+"").split(" "),f={},r.forEach(function(_,g){return f[_]=d[g]=d[g]||d[(g-1)/2|0]}),a.init(c,f,u)}});var im={name:"css",register:Kl,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,n,i,s){var r=this._props,a=e.style,c=n.vars.startAt,l,h,u,d,f,_,g,p,m,v,x,M,w,T,b,R;Bh||Kl(),this.styles=this.styles||$p(e),R=this.styles.props,this.tween=n;for(g in t)if(g!=="autoRound"&&(h=t[g],!(hn[g]&&zp(g,t,n,i,e,s)))){if(f=typeof h,_=Ba[g],f==="function"&&(h=h.call(n,i,e,s),f=typeof h),f==="string"&&~h.indexOf("random(")&&(h=po(h)),_)_(this,e,g,h,n)&&(b=1);else if(g.substr(0,2)==="--")l=(getComputedStyle(e).getPropertyValue(g)+"").trim(),h+="",Wi.lastIndex=0,Wi.test(l)||(p=Vt(l),m=Vt(h)),m?p!==m&&(l=ji(e,g,l,m)+m):p&&(h+=p),this.add(a,"setProperty",l,h,i,s,0,0,g),r.push(g),R.push(g,0,a[g]);else if(f!=="undefined"){if(c&&g in c?(l=typeof c[g]=="function"?c[g].call(n,i,e,s):c[g],Dt(l)&&~l.indexOf("random(")&&(l=po(l)),Vt(l+"")||l==="auto"||(l+=pn.units[g]||Vt(pi(e,g))||""),(l+"").charAt(1)==="="&&(l=pi(e,g))):l=pi(e,g),d=parseFloat(l),v=f==="string"&&h.charAt(1)==="="&&h.substr(0,2),v&&(h=h.substr(2)),u=parseFloat(h),g in Xn&&(g==="autoAlpha"&&(d===1&&pi(e,"visibility")==="hidden"&&u&&(d=0),R.push("visibility",0,a.visibility),zi(this,a,"visibility",d?"inherit":"hidden",u?"inherit":"hidden",!u)),g!=="scale"&&g!=="transform"&&(g=Xn[g],~g.indexOf(",")&&(g=g.split(",")[0]))),x=g in Mi,x){if(this.styles.save(g),M||(w=e._gsap,w.renderTransform&&!t.parseTransform||vo(e,t.parseTransform),T=t.smoothOrigin!==!1&&w.smooth,M=this._pt=new nn(this._pt,a,ut,0,1,w.renderTransform,w,0,-1),M.dep=1),g==="scale")this._pt=new nn(this._pt,w,"scaleY",w.scaleY,(v?hr(w.scaleY,v+u):u)-w.scaleY||0,Yl),this._pt.u=0,r.push("scaleY",g),g+="X";else if(g==="transformOrigin"){R.push(sn,0,a[sn]),h=jb(h),w.svg?$l(e,h,0,T,0,this):(m=parseFloat(h.split(" ")[2])||0,m!==w.zOrigin&&zi(this,w,"zOrigin",w.zOrigin,m),zi(this,a,g,za(l),za(h)));continue}else if(g==="svgOrigin"){$l(e,h,1,T,0,this);continue}else if(g in em){Jb(this,w,g,d,v?hr(d,v+h):h);continue}else if(g==="smoothOrigin"){zi(this,w,"smooth",w.smooth,h);continue}else if(g==="force3D"){w[g]=h;continue}else if(g==="transform"){Qb(this,h,e);continue}}else g in a||(g=Rr(g)||g);if(x||(u||u===0)&&(d||d===0)&&!Db.test(h)&&g in a)p=(l+"").substr((d+"").length),u||(u=0),m=Vt(h)||(g in pn.units?pn.units[g]:p),p!==m&&(d=ji(e,g,l,m)),this._pt=new nn(this._pt,x?w:a,g,d,(v?hr(d,v+u):u)-d,!x&&(m==="px"||g==="zIndex")&&t.autoRound!==!1?Ob:Yl),this._pt.u=m||0,p!==m&&m!=="%"&&(this._pt.b=l,this._pt.r=Fb);else if(g in a)Yb.call(this,e,g,l,v?v+h:h);else if(g in e)this.add(e,g,l||e[g],v?v+h:h,i,s);else if(g!=="parseTransform"){Ch(g,h);continue}x||(g in a?R.push(g,0,a[g]):R.push(g,1,l||e[g])),r.push(g)}}b&&Xp(this)},render:function(e,t){if(t.tween._time||!zh())for(var n=t._pt;n;)n.r(e,n.d),n=n._next;else t.styles.revert()},get:pi,aliases:Xn,getSetter:function(e,t,n){var i=Xn[t];return i&&i.indexOf(",")<0&&(t=i),t in Mi&&t!==sn&&(e._gsap.x||pi(e,"x"))?n&&jd===n?t==="scale"?Vb:kb:(jd=n||{})&&(t==="scale"?Hb:Gb):e.style&&!wh(e.style[t])?Bb:~t.indexOf("-")?zb:Fh(e,t)},core:{_removeProperty:As,_getMatrix:Vh}};rn.utils.checkPrefix=Rr;rn.core.getStyleSaver=$p;(function(o,e,t,n){var i=tn(o+","+e+","+t,function(s){Mi[s]=1});tn(e,function(s){pn.units[s]="deg",em[s]=1}),Xn[i[13]]=o+","+e,tn(n,function(s){var r=s.split(":");Xn[r[1]]=i[r[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");tn("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(o){pn.units[o]="px"});rn.registerPlugin(im);var xo=rn.registerPlugin(im)||rn;xo.core.Tween;const ew=document.querySelector("canvas.webgl"),Is=new Dy,sm=new EM;let ka=null,Xi,xa,ki;const gs=.05;sm.load("/models/carpet.glb",o=>{ki=o.scene,ki.scale.set(gs,gs,gs),Is.add(ki)});sm.load("/models/wave.glb",o=>{xa=o.scene,o.scene.scale.set(gs,gs,gs),Is.add(o.scene);const e=o.scene.children[0].children[0].geometry;console.log(e);const t=e.attributes.position.array,n=e.index.array,i=gs,s=Array.from(t).map((a,c)=>(c%3===0||c%3===1,a*i)),r=new La(s,Array.from(n));if(Xi=new fe({mass:1,shape:r,position:new E(0,1,0)}),To.addBody(Xi),o.animations.length>0){ka=new SM(o.scene);const a=ka.clipAction(o.animations[0]);a.loop=yf,a.play()}});const rm=new _t(new bs(10,10),new Xa({color:"#444444",metalness:0,roughness:.5}));rm.receiveShadow=!0;rm.rotation.x=-Math.PI*.5;const tw=new aM(16777215,2.4);Is.add(tw);const Ei=new jf(16777215,1.8);Ei.castShadow=!0;Ei.shadow.mapSize.set(1024,1024);Ei.shadow.camera.far=15;Ei.shadow.camera.left=-7;Ei.shadow.camera.top=7;Ei.shadow.camera.right=7;Ei.shadow.camera.bottom=-7;Ei.position.set(-5,5,0);Is.add(Ei);const Vn={width:window.innerWidth,height:window.innerHeight};window.addEventListener("resize",()=>{Vn.width=window.innerWidth,Vn.height=window.innerHeight,Cr.aspect=Vn.width/Vn.height,Cr.updateProjectionMatrix(),Rs.setSize(Vn.width,Vn.height),Rs.setPixelRatio(Math.min(window.devicePixelRatio,2))});const Cr=new Yt(75,Vn.width/Vn.height,.1,3e3);Cr.position.set(0,4,10);Is.add(Cr);Cr.rotation.x=-Math.PI/12;const Rs=new Ny({canvas:ew});Rs.shadowMap.enabled=!0;Rs.shadowMap.type=af;Rs.setSize(Vn.width,Vn.height);Rs.setPixelRatio(Math.min(window.devicePixelRatio,2));const To=new LT;To.gravity.set(0,-9.82,0);const gi=new fe({mass:0,shape:new aE,position:new E(0,0,0)});gi.quaternion.setFromEuler(-Math.PI/2,0,0);To.addBody(gi);gi.type=fe.KINEMATIC;function nf(o){const e=gi.position.clone(),t=o.clone();xo.to(e,{duration:1,delay:.25,x:t.x,y:t.y,z:t.z,ease:"power2.out",onUpdate:()=>{gi.position.set(e.x,e.y,e.z)}})}let Ls=!1,Pr=0,fr=0,oo=0;const Zl=-10,Jl=10;window.addEventListener("mousedown",o=>{Ls=!0,Pr=o.clientX});let Zc=null;window.addEventListener("mousemove",o=>{if(Ls){if(fr=o.clientX,oo=fr-Pr,oo<0){nf(new E(0,-20,0));const e=Aa.clamp(ki.position.x-5,Zl,Jl);xo.to(ki.position,{duration:.5,x:e,ease:"power2.out"})}else if(oo>0){nf(new E(0,-20,0));const e=Aa.clamp(ki.position.x+5,Zl,Jl);xo.to(ki.position,{duration:.5,x:e,ease:"power2.out"})}Pr=fr,Zc&&clearTimeout(Zc),Zc=setTimeout(nw,4500)}});window.addEventListener("mouseup",()=>{Ls=!1});function nw(){gi.position.set(0,0,0),xo.to(ki.position,{duration:.5,x:0,y:0,z:0,ease:"power2.out"}),Xi&&(Xi.position.set(0,1,0),Xi.velocity.set(0,0,0))}window.addEventListener("mouseup",()=>{Ls=!1});window.addEventListener("touchstart",o=>{Ls=!0,Pr=o.touches[0].clientX});window.addEventListener("touchmove",o=>{if(!Ls)return;fr=o.touches[0].clientX,oo=(fr-Pr)*.01;const e=Aa.clamp(gi.position.x+oo,Zl,Jl);updateGroundPosition(new E(e,gi.position.y,gi.position.z)),Pr=fr});window.addEventListener("touchend",()=>{Ls=!1});const sf=new lM;let rf=0;new zT(Is,To,{color:65280});const om=()=>{const o=sf.getDelta();To.step(1/60,o),Xi&&xa&&(xa.position.copy(Xi.position),xa.quaternion.copy(Xi.quaternion));const e=sf.getElapsedTime(),t=e-rf;rf=e,ka&&ka.update(t*.35),Rs.render(Is,Cr),window.requestAnimationFrame(om)};om();
//# sourceMappingURL=index-D8mmL8Me.js.map
